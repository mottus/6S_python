This is a python translation of the original sixs fortran code. The original code came without a copyright notice or a readme file. Likely, it is not copyrighted - and neither is the python translation. I have no recollection where I downloaded it from decades ago. It has almost no dependencies, so use it as you like. There are no promises or guarantees. The translation was done in early 2026 by Claude (Sonnet 4.6) with minimum human help or oversight. Claude checked and debugged it itself, see 6S\_Python\_Conversion\_Notes.md for details. The code is slow and unoptimized, for any production environment the fortran version (an updated version of it!) would be preferred. The purpose of this translation is enabling quick ad-hoc test runs and testing modifications without learning (the Windows installation of) fortran 77, e.g. in educational use. I used the code and translated it for my own use - and made it available for reference only (e.g., of Claude's capability in 2026) without any claims of usability.
...
Despite a lack of active development, bugfixes are still welcome. And note the last paragraph Claude wrote in 6S\_Python\_Conversion\_Notes - some numerical inaccuracies may still be present.
